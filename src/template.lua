--[[
# 日本語 ########################################
このファイルは、AviUtlスクリプトのためのLuaファイルの雛形です。
...
# English ########################################
This file is a template for a Lua program file of AviUtl.
...
This file is part of script/plugin "YOUR_PROGRAM_NAME_HERE" of AviUtl.

"YOUR_PROGRAM_NAME_HERE" is free software: you can redistribute it and/or modify it
under the terms of the GNU Lesser General Public License as published by the Free software
Foundation, either version 3 of the License, or (at your option) any later version.

"YOUR_PROGRAM_NAME_HERE" is distributed in the hope that it will be useful, but WITHOUT
...
-- if you want to make this file as a module, please uncomment the following line.
--[[
return {
    -- WRITE HERE WHAT YOU WANT TO EXPORT --
}
]]
